DROP DATABASE IF EXISTS kd13rsk;
CREATE DATABASE kd13rsk;

GRANT ALL on kd13rsk.* to 'kd13rsk'@'localhost' IDENTIFIED BY 'kd13rsk';
GRANT ALL on kd13rsk.* to 'kd13rsk'@'%' IDENTIFIED BY 'kd13rsk';

USE `kd13rsk`;
-- MySQL dump 10.13  Distrib 5.1.34, for apple-darwin9.5.0 (i386)
--
-- Host: localhost    Database: kd13rsk
-- ------------------------------------------------------
...
CREATE TABLE `TRVL_DEST_T` (
  `TRVL_DEST_ID` varchar(40) COLLATE utf8_bin NOT NULL DEFAULT '',
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  ...
  UNIQUE KEY `TRVL_DEST_TC0` (`OBJ_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `TRVL_DEST_T` VALUES ('10000','EA7510AEABE85C3FE0406E0AC31D48D8','1','Colorado','US','CO','Y');
...
CREATE TABLE `TRVL_CO_T` (
  `CO_ID` varchar(40) COLLATE utf8_bin NOT NULL DEFAULT '',
  `CO_NM` varchar(40) COLLATE utf8_bin NOT NULL,
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `ACTV_IND` varchar(1) COLLATE utf8_bin NOT NULL DEFAULT 'Y',
  PRIMARY KEY (`CO_ID`),
  UNIQUE KEY `TRVL_CO_TC0` (`OBJ_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `TRVL_CO_T` VALUES ('10000','Value Rentals','EA7510AEABEA5C3FE0406E0AC31D48D8','1','Y'),('10001','AAA Travel','EA7510AEABEF5C3FE0406E0AC31D48D8','1','N');
...
CREATE TABLE `TRVL_TRAVELER_DTL_T` (
  ...
  `DRIVE_LIC_EXP_DT` datetime DEFAULT NULL,
...
INSERT INTO `TRVL_TRAVELER_DTL_T` VALUES ('1','IMAGUID','1','Y','US','Davis','US','CUST','??',NULL,NULL,NULL,'Test','M','Traveler','A','N','8005551212','fred','CA','123 Nowhere St.',NULL,'123','95616');
...
CREATE TABLE `TRVL_AUTH_DOC_T` (
  `TRVL_AUTH_DOC_ID` varchar(19) COLLATE utf8_bin NOT NULL DEFAULT '',
  `TRAVELER_DTL_ID` varchar(14) COLLATE utf8_bin DEFAULT NULL,
  ...
  UNIQUE KEY `TRVL_AUTH_TC0` (`OBJ_ID`),
  KEY `TRVL_AUTH_FK1` (`TRVL_DEST_ID`),
  CONSTRAINT `TRVL_AUTH_FK1` FOREIGN KEY (`TRVL_DEST_ID`) REFERENCES `trvl_dest_t` (`TRVL_DEST_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `TRVL_AUTH_DOC_T` VALUES ('10000','1','IS','2013-12-01 00:00:00','2013-12-01 00:00:00','10000','1000.00','Kuali Days Conference','1234567','EA7510AEABEB5C3FE0406E0AC31D48D8','1');
...
CREATE TABLE `TRVL_PD_EXP_T` (
  `PD_EXP_ID` varchar(40) COLLATE utf8_bin NOT NULL DEFAULT '',
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  ...
  UNIQUE KEY `TRVL_PD_EXP_TC0` (`OBJ_ID`),
...
INSERT INTO `TRVL_PD_EXP_T` VALUES ('10000','EA7510AEABEC5C3FE0406E0AC31D48D8','1','10000','10000','2013-11-05 20:42:04','10.00','10.00','15.00','20.00','10000','30');
...
INSERT INTO `TRV_ACCT` VALUES ('a1','a1','1','Travel Account 1','IAT','fred',NULL,NULL),('a10','a10','1','Travel Account 10','CAT','eric',NULL,'75.00'),('a11','a11','1','Travel Account 11','EAT','erin',NULL,'85.00'),('a12','a12','1','Travel Account 12','EAT','eric',NULL,'85.00'),('a13','a13','1','Travel Account 13','CAT','fran',NULL,'95.00'),('a14','a14','1','Travel Account 14','CAT','fran',NULL,NULL),('a2','a2','1','Travel Account 2','EAT','fran',NULL,NULL),('a3','a3','1','Travel Account 3','IAT','frank',NULL,'20.00'),('a4','a4','1','Travel Account 4','IAT','erin',NULL,'45.00'),('a5','a5','1','Travel Account 5','IAT','eric',NULL,'45.00'),('a6','a6','1','Travel Account 6','CAT','fran',NULL,NULL),('a7','a7','1','Travel Account 7','CAT','erin',NULL,'75.00'),('a8','a8','1','Travel Account 8','EAT','fran',NULL,NULL),('a9','a9','1','Travel Account 9','CAT','fran',NULL,NULL);
...
INSERT INTO `TRV_ACCT_TYPE` VALUES ('CAT','Clearing','CAT','1'),('EAT','Expense','EAT','1'),('IAT','Income','IAT','1');
...
CREATE TABLE `TRVL_EXP_ITM_T` (
  `EXP_ITM_ID` varchar(40) COLLATE utf8_bin NOT NULL DEFAULT '',
  `OBJ_ID` varchar(36) COLLATE utf8_bin NOT NULL,
  `VER_NBR` decimal(8,0) NOT NULL DEFAULT '1',
  `TRVL_AUTH_DOC_ID` varchar(40) COLLATE utf8_bin NOT NULL,
  ...
  UNIQUE KEY `TRVL_EXP_ITEM_TC0` (`OBJ_ID`),
  KEY `TRVL_EXP_ITEM_FK1` (`TRVL_AUTH_DOC_ID`),
  CONSTRAINT `TRVL_EXP_ITEM_FK1` FOREIGN KEY (`TRVL_AUTH_DOC_ID`) REFERENCES `trvl_auth_doc_t` (`TRVL_AUTH_DOC_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `TRVL_EXP_ITM_T` VALUES ('10000','EA7510AEABED5C3FE0406E0AC31D48D8','1','10000','Discount Travel','ME','30.00','Family Related','2013-11-05 20:42:04','Y','Y');
...
CREATE TABLE `TRVL_CO_ID_S` (
  `id` bigint(19) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10021 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TRVL_MLG_RT_T` (
  `MLG_RT_ID` varchar(40) COLLATE utf8_bin NOT NULL DEFAULT '',
  ...
  UNIQUE KEY `TRVL_MIL_RT_TC0` (`OBJ_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `TRVL_MLG_RT_T` VALUES ('10000','DO','EA7510AEABE95C3FE0406E0AC31D48D8','1','Domestic','30','Y');
...
/*!50001 DROP TABLE `krim_grp_mbr_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_grp_mbr_v`*/;
...
/*!50013 DEFINER=`kd13rsk`@`localhost` SQL SECURITY DEFINER */
...
/*!50001 DROP TABLE `krim_perm_attr_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_perm_attr_v`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE `krim_prncpl_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_prncpl_v`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE `krim_role_grp_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_role_grp_v`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE `krim_role_perm_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_role_perm_v`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE `krim_role_prncpl_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_role_prncpl_v`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE `krim_role_role_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_role_role_v`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE `krim_rsp_attr_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_rsp_attr_v`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE `krim_rsp_role_actn_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_rsp_role_actn_v`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE `krim_rsp_role_v`*/;
/*!50001 DROP VIEW IF EXISTS `krim_rsp_role_v`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
--
-- Dumping routines for database 'kd13rsk'
--
...
-- Dump completed on 2013-11-07 19:58:34
